...
<body>
    ...
    <div class="page-body container-fluid custom-padding">
                                    ...
                                    <div class="like-panel">
                                        <div class="left-emoji">
                                            <ul>
                                                ...
                                                <li>
                                                    <img src="https://themes.pixelstrap.com/friendbook/assets/svg/emoji/033.svg" alt="angry">
                                                </li>
                                            </ul>
                                            <h6>+75</h6>
                                        </div>
                                            ...
                                            <li class="react-btn">
                                                ...
                                                <div class="react-box">
                                                    <ul>
                                                        ...
                                                        <li data-title="haha">
                                                            <a href="javascript:void(0)">
                                                                <img src="https://themes.pixelstrap.com/friendbook/assets/svg/emoji/042.svg" alt="">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
        ...
        <div class="conversation-panel xl-light">
            ...
            <div class="friend-section">
                <div class="header-section">
                    <a data-bs-toggle="collapse" href="#accordion" role="button" aria-expanded="true" class="">close
                        friends
                        <div class="down-arrow">
    ...
    <!-- story model start -->
    <div class="modal story-model" id="storyModel" tabindex="-1" role="dialog" aria-labelledby="storyModel" aria-hidden="true">
    ...
    <div class="modal fade bd-example-modal-lg" id="videoPlayer" aria-labelledby="videoPlayer" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <!-- gallery image model -->
    <div class="modal comment-model" id="imageModel" aria-labelledby="imageModel"  tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div>
    ...
    <div class="modal fade mobile-full-width" id="shareModal" aria-labelledby="shareModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
